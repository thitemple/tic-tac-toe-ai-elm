...
// module
exports.push([module.i, ".ttt-main-container {\r\n    width: 700px;\r\n    margin: 0 auto;\r\n}\r\n\r\n.ttt-new-game {\r\n    margin: 10px 0;\r\n}\r\n\r\nbutton > i {\r\n    margin-right: 10px;\r\n}\r\n\r\n.ttt-score {\r\n    letter-spacing: 5px;\r\n}\r\n\r\n.ttt-score > i:first-of-type {\r\n    margin-right: 10px;\r\n}\r\n\r\n.ttt-score > i:last-of-type {\r\n    margin-left: 10px;\r\n}", ""]);
...
var _user$project$Canvas$drawBase = function (x) {
	return A2(
...
var _user$project$Canvas$renderBox = function (size) {
	var forms = A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
			_0: _user$project$Canvas$drawBase(
				_elm_lang$core$Basics$toFloat(size)),
			_1: {ctor: '[]'}
		},
		_user$project$Canvas$drawFrame(
			_user$project$Canvas$lines(
				_elm_lang$core$Basics$toFloat(size))));
	return _evancz$elm_graphics$Element$toHtml(
		A3(_evancz$elm_graphics$Collage$collage, size, size, forms));
};
...
var _user$project$Model$Score = F2(
	function (a, b) {
		return {ai: a, human: b};
	});
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {ended: a, started: b, lastMove: c, isAiTurn: d, aiStarted: e, score: f};
	});

var _user$project$Msgs$AiMove = {ctor: 'AiMove'};
var _user$project$Msgs$AskAiMove = {ctor: 'AskAiMove'};
var _user$project$Msgs$SelectPosition = {ctor: 'SelectPosition'};
var _user$project$Msgs$NewGame = {ctor: 'NewGame'};

var _user$project$View$newGameButton = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('btn btn-primary ttt-new-game'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Msgs$NewGame),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fa fa-play'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
...
var _user$project$View$score = function (score) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('ttt-score regular h3'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(score.human)),
				_1: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(score.ai)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$i,
...
var _user$project$View$gameCanvas = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Canvas$renderBox(200),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('flex flex-column items-center'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$score(model.score),
			_1: {
				ctor: '::',
				_0: _user$project$View$gameCanvas(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$newGameButton,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'NewGame':
				return {ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SelectPosition':
